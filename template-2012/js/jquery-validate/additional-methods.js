...
jQuery.validator.addMethod("telFixo", function(value, element) {
	var m = new Array();
            ...
            return this.optional(element) || value.substr(5,1) in m;
            
}, jQuery.format("Você deve inserir um número de telefone fixo."));
