...
EOD;
    ...
    $sql = "insert into chat (chat.email,chat.from,chat.to,message,sent) values ('" . mysql_real_escape_string($email) . "' , '" . mysql_real_escape_string($from) . "', '" . mysql_real_escape_string($to) . "','" . mysql_real_escape_string($message) . "',NOW())";
