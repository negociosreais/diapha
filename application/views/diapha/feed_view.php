        ...
        <ul class="nav nav-pills nav-stacked">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="?view=feed&meusrelatos=<?= $meusrelatos; ?>&intervalo=">Todos</a>
                    </li>
                    <li class="divider"></li>
                    <li>
                        <a href="?view=feed&meusrelatos=<?= $meusrelatos; ?>&intervalo=Hoje">Hoje</a>
                    </li>
                    <li>
                        <a href="?view=feed&meusrelatos=<?= $meusrelatos; ?>&intervalo=Esta semana">Esta semana</a>
                    </li>
                    <li>
                        <a href="?view=feed&meusrelatos=<?= $meusrelatos; ?>&intervalo=Este mês">Este mês</a>
                    </li>
                    <li>
                        <a href="?view=feed&meusrelatos=<?= $meusrelatos; ?>&intervalo=Este ano">Este ano</a>
                    </li>
                </ul>
            </li>
        </ul>
    ...
    <div >
        ...
        <div class="feeds">
            ...
            if ($relatos):
                        ...
                        <div class="feed-content caixa">
                            ...
                            <div class="feed-footer">
                                ...
                                <div style="float: left">
                                    ...
                                    elseif ($relato['st_status'] == '0' || $relato['st_status'] == '1'):

                                        if ((in_array($relato['nm_apelido'], $arr) && checa_permissao(array('orgao'), true)) || $relato['fb_email'] == usuario('email_facebook')):

                                            if ($relato['st_status'] == '0'):
                                                ?>
                                                <button class="btn btn-warning" onclick="mostrarStatus(1, '<?= $relato[id_relato]; ?>')" style="padding: 6px;">Marcar em análise</button>
                                                <?
                                            elseif ($relato['st_status'] == '1'):
                                                ?>
                                                <button class="btn btn-success" onclick="mostrarStatus(2, '<?= $relato[id_relato]; ?>')" style="padding: 6px;">Marcar como resolvido</button>
                                                <?
                                            endif;
                                    ...
                                    <a href="<?= site_url('relato/' . $relato['nm_apelido'] . '/detalhes?id=' . $relato['id_relato']); ?>" class="btn btn-info" title="Ver mais detalhes do relato" style="padding: 8px">
                                    ...
                                    if ($apoiado):
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-primary" title="Você já apoia esta denúncia" style="padding: 6px" disabled="disabled">
                                            <i class="icon-thumbs-up icon-white"></i> Apoiado <span class="badge badge-inverse"><?= $relato['apoios']; ?></span>
                                        </a>
                                        <?
                                    else:
                                        ?>
                                        <a href="javascript:apoio('<?= $relato['id_relato']; ?>','<?= usuario('id_usuario'); ?>')" id="apoio-<?= $relato['id_relato']; ?>" class="btn btn-primary"
                                           title="Clique aqui para apoiar esta denúncia" style="padding: 6px">
                                            <i class="icon-thumbs-up icon-white"></i> <span class="texto">Apoio</span> <span class="badge badge-inverse"><?= $relato['apoios']; ?></span>
                                        </a>
                                    <?
                                    endif;
                                    ?>
                ...
                ?>
                <div class="alert alert-info">Ainda não existem relatos para esta cidade</div>
            <?
            endif;
            ?>
