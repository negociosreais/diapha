...
?>
    ...
    <div class="caixa">
        ...
        <div class="diaphe">
            ...
            <form name="form_diaphe" id="form_diaphe" action="<?= site_url('post/inserir'); ?>" method="POST">

                <div class="textoEsquerda">
                    <span id="numero11">
                        <textarea name="ds_post" id="ds_post" maxlength="280">Digite aqui sua mensagem</textarea>
                    </span>
                    <span class="contadorCaracteres">280</span>
                </div>
                <div class="opcoesDireita">

                    <input type="button" name="btnDiaphe" id="btnDiaphe" value="Enviar" class="btn btn-info" />
                </div>
        ...
        <div id="tabs">
            <ul>
                <li><span id="numero12"><a href="#tabs-1" title="">Publicações</a></span></li>
                <li><span id="numero13"><a href="#tabs-2" title="">Estou seguindo</a></span></li>
            </ul>
            <div id="tabs-1">
                <table width="100%" class="lista diapha">
                                        ...
                                        <tr id="trComentar-<?= $post['id_post']; ?>" class="trBranco">
                                            <td colspan="2">
                                                <div class="diaphe">
                                                    ...
                                                    <div class="textoEsquerda">
                                                        <textarea name="ds_comentario" id="ds_comentario_<?= $post['id_post']; ?>" class="comentario" maxlength="280"></textarea>
                                                        <span class="contadorCaracteres">280</span>
                                                    </div>
                                                    <div class="opcoesDireita">
                    ...
                    if (count($posts) > 1):
                        ...
                        <tr class="trBranco">
                            <td colspan="3">
                                <button id="mostrarMaisPost" class="btn btn-success cemPorcento">MOSTRAR MAIS</button>
                            </td>
                        </tr>
                        <?
                    endif;
                    ...
                    if (count($interesses) > 0) :
                        ...
                        foreach ($interesses as $post) :
                            ...
                            <tr class="trBranco <?= $opcoes; ?>" id="<?= $post['id_post']; ?>">
                                ...
                                <td>
                                    <b class="nomeEmpresa"><?= $nm_empresa; ?></b>
                            ...
                            <tr class="trInterna">
                                <td colspan="3">
                                    <table width="100%" class="comentarios">
                                        ...
                                        <tr id="trComentar-seguindo-<?= $post['id_post']; ?>" class="trBranco">
                                            <td colspan="2">
                                                <div class="diaphe">

                                                    <div class="textoEsquerda">
                                                        <textarea name="ds_comentario" id="ds_comentario_seguindo_<?= $post['id_post']; ?>" class="comentario" maxlength="280"></textarea>
                                                        <span class="contadorCaracteres">280</span>
                                                    </div>
                                                    <div class="opcoesDireita">
                                                        <input type="button" name="btnComentar" onclick="comentar('<?= $post['id_post']; ?>')" value="Comentar" class="btn btn-success" />
                                        ...
                                        if ($comentarios):
                                            ...
                                            foreach ($comentarios as $comentario):
                                                ...
                                                <tr class="trBranco <?= $opcoes; ?>" id="<?= $comentario['id_comentario']; ?>">
                                                    ...
                                                    <td>
                                                        <b class="nomeEmpresa"><?= $nm_usuario; ?> : </b>
