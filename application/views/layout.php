...
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
        <title>Atas de Registro de Preço - Portal ARP</title>
        ...
        <script type="text/javascript" src="<?= base_url() . TEMPLATE; ?>/js/jquery-1.7.2.js"></script>
            ...
            <div class="barraLateral">
                <div class="grid_5">
                    ...
                    if (checa_permissao(array('admin', 'operador'), true)):
                        include_once("inc/usuarios_online_view.php");
                    endif;
                    ?>
